  ...
  return (
    <>
      <div className="p-2 m-2 border rounded-lg border-cyan-700 ">
        ...
        <Link to={`/modificarZapatilla/${id}`} state={{ name, description, price, id, color, brand}} className="p-2 m-2 text-yellow-600 border rounded-lg border-yellow-600 ">Modificar</Link>
      </div>
      {msg && (
